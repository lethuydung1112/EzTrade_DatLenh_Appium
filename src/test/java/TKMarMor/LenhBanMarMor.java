...
public class LenhBanMarMor extends BaseTest{
    @BeforeClass
...
//        dL.clickXacNhan();
//    }
//    @Test(dataProvider = "HSX_Sell_MarMor",dataProviderClass = Data_Ban_MarMor.class,priority = 3)
...
//        dL.clickXacNhan();
//    }
//    @Test(dataProvider = "HSX_Sell_MarMor",dataProviderClass = Data_Ban_MarMor.class,priority = 4)
